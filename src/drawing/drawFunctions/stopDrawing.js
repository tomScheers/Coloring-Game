...
export const stopDrawing = () => {
    ...
    const totalDataColorValue = data.reduce((totalColorValue, currentColorValue) => totalColorValue + currentColorValue, 0);
    const totalColorValueCurrentCanvas = userData.canvasVersions[userData.canvasVersions.length - 1]?.reduce((totalColorValue, currentColorValue) => totalColorValue + currentColorValue, 0) || 0;
